...
function SignUp() {
    const handleSubmit = async (e) => {
        ...
        const url = "http://localhost:8080/members"; // 프로토콜 추가
        const dataToSend = {
            ...formData,
        ...
        try {
            const response = await postData(url, dataToSend);
    ...
    return (
        <div className="flex flex-col justify-center items-center w-full max-w-6xl mx-auto p-4 ml-0 mr-0">
            {/* 차량 등록 폼 컨테이너 */}
            <div className="fixed left-[426px] top-[17px] flex flex-col justify-center items-start w-full  rounded-md p-4">
                <h1 className="text-2xl font-bold mb-4">업체등록</h1>
                            ...
                            cellStyle={(rowIndex, colIndex) => {
                                ...
                                if (colIndex === 1) {
                                    return {
                                        ...
                                        border: "",
                                        display: "flex",
                                        justifyContent: "flex-start", // input 박스를 왼쪽 정렬
                                        alignItems: "center", // 세로 정렬 (필요하면 추가)
                                    };
                                }
                                return {};
                            }}
